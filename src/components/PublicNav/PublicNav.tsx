...
import { getIcon, LanguageSwitcher, LanguagePills } from '@/components';
          ...
          <div className="md:hidden border-t border-gray-200 py-4">
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col space-y-2 pt-4 border-t border-gray-200">
                <div className="pb-2">
                  <LanguagePills onLanguageChange={() => setIsMobileMenuOpen(false)} />
                </div>
                <Link
                  href={authItems.login.href}
                  className="w-full bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 text-center"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  {t(authItems.login.labelKey)}
                </Link>
